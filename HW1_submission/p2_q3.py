...
#normalized version of simplefc2
for dropoutFraction in [0.0,0.2,0.5,0.8]:
    ...
    # plt.legend()
    # plt.savefig('simpleFC_3/lossplot_2_3_normalized_%.1f.png'%(dropoutFraction))
    # plt.clf()
    # print('\n')
