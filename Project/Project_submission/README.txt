...
5) Deploy this onnx on the raspberry pi using the included deploy_onnx.py file. You will have to use the args "--model" and "--target" with the values of the onnx filepath and "rpi" respectively. The "get_power_temp_rpi.py" file is a dependency, 
